...
import ImpressorAcomodacao from "./impressorAcomod";
import ImpressorDocumentos from "./impressorDocuments";
import ImpressorEndereco from "./impressorEndereco";
import ImpressorTelefones from "./impressorTel";

export default class ImpressorClienteDP implements Impressor {
