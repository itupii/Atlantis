...
import MenuTipoAcomodacao from "../menus/menuTipoAcomod";
...
export default class CadastrarAcomodacaoCliente extends Processo {
    ...
    processar(): void {
        ...
        let opcao = this.entrada.recebeNumero("Digite a acomodação desejada: ");
